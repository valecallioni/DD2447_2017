...
x11()
heatmap(Z, main="Final feature matrix", xlab = "Features / Dishes", ylab = "Customers")

x11()
heatmap(Z1, main="Initial feature matrix generated by the IBP", xlab = "Features / Dishes", ylab = "Customers")
